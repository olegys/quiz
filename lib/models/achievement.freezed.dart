...
mixin _$Achievement {
  ...
  AchievementGroup get group => throw _privateConstructorUsedError;
...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(id: $id, title: $title, description: $description, group: $group, icon: $icon, isUnlocked: $isUnlocked)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, group, icon, isUnlocked);
...
abstract class _Achievement implements Achievement {
  const factory _Achievement(
      ...
      required final AchievementGroup group,
