...
mixin _$TriviaCategory {
  ...
  /// Serializes this TriviaCategory to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of TriviaCategory
...
class _$TriviaCategoryImpl implements _TriviaCategory {
  const _$TriviaCategoryImpl({required this.id, required this.name});
